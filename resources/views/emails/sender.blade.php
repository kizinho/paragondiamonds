<div bgcolor="#ecedf6">
    <table border="0" cellpadding="0" cellspacing="0" width="100%" align="center" bgcolor="#102274">
        <tbody><tr><td>
                    <table width="550px" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" align="center" style="width:550px;margin:0 auto;max-width:550px">
                        <tbody><tr><td valign="top">
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff">
                                        <tbody><tr><td>
                                                    <img src="{{asset($settings['logo']) }}" style="display:block" class="CToWUd a6T" tabindex="0"><div class="a6S" dir="ltr" style="opacity: 0.01; left: 502px; top: 169px;">
                                            ...
                                            <tr><td bgcolor="#ffffff" style="padding-top:40px;padding-right:35px;padding-bottom:40px;padding-left:35px">
                                                    ...
                                                    <table border="0" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td align="center" style="border-radius:22px" bgcolor="#102274">
                            ...
                            <tr><td valign="top">
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#102274">
